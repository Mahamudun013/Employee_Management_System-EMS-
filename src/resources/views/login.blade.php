        ...
        @if(session('info'))
         ...
         @endif
            ...
            <form class="form-signin"  method="post" action="{{ url('/admin')}}">
                ...
                <input type="text" id="inputEmail" class="login_box" placeholder="Enter Email" name="email" required autofocus>
                <p class="input_title">Password</p>
                <input type="password" id="inputPassword" class="login_box" placeholder="Enter Password"
