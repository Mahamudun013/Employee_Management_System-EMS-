...
<body>
    ...
    <div class="container">
    <h1 class="welcome text-center">Welcome to <br>Employee Management System</h1>
        ...
        @if(session('info'))
         ...
         @endif
            ...
            <form class="form-signin"  method="post" action="{{ url('/admin')}}">
                ...
                <input type="text" id="inputEmail" class="login_box" placeholder="Enter Email(mahamudun013@gmail.com)" name="email" required autofocus>
                <p class="input_title">Password</p>
                <input type="password" id="inputPassword" class="login_box" placeholder="Enter Password(mukut123)" name="password" required>
